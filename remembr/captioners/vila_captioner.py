...
try:
    ...
    print(f"Error importing llava.constants: {e}")
    # Add VILA path to sys.path if not already there
    import sys
    vila_path = '/home/yhu/codespace/nav_mem/deps/VILA'
    ...
    try:
        ...
        # Fallback constants if VILA is not available
