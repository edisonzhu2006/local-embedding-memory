...
class NonAgent(Agent):
    def __init__(self, llm_type='llama3', num_ctx=8192, temperature=0, prompt_dir="unknown"):
        ...
        self.prompt = file_to_string(str(os.path.dirname(__file__)) + '/../' + f'{prompt_dir}/non_agent_system_prompt.txt')
