...
DATA_CSV = "./data_vlm/navqa/data.csv"
DATA_PATH = "./data_vlm"
...
def main(args):
    ...
    files = glob.glob(os.path.join('./data_vlm', 'navqa', '*', 'qa_unfilled.json'))
    ...
    for i, seq_id in enumerate(seq_ids):
        ...
        print(f"Saving data for sequence {seq_id} in ./data_vlm/questions/{seq_id}/human_qa.json")
        # make dir if it does not exist
        os.makedirs(f'./data_vlm/questions/{seq_id}', exist_ok=True)

        with open(f'./data_vlm/questions/{seq_id}/human_qa.json', 'w') as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--convert_path", type=str, default="./data_vlm/convert/{seq_id}/{convert_file}.json")
...
"""
python scripts/preprocess_vlm_questions.py --convert_file convert_3_secs --overwrite
"""